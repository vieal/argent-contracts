 ...
 * this module are directly owned by the module. This is to prevent a compromised owner from
 * being able to use `TransferManager.callContract()` to transfer ownership of a vault
